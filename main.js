...
const clienteEzio = new Cliente("Ezio", "Barboni", 44805160, "Premiun")
const clienteMartina = new Cliente("Martina", "Vecci", 43604970, "Basic")
const clienteLucas = new Cliente("Lucas", "Martinez", 41804170, "Basic")

const arrayClientes = [clienteEzio, clienteMartina, clienteLucas]
